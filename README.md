...
Summary of Pract1:
                From this practicals i have a gained a information about the various sorting algorithms,i have used the PYTHON as my Programming Language
                      ...
                      4.Merge Sort
                      5.Quick Sort
                My faculty helped me out the errors through the practicals ,Sorting the numbers depends on the following factors as Data set size,Memory usage,Data                           order & Performance requirements.
Conclusion:    
...
Summary of pract2:
               ...
               My faculty helped me out the errors through the practicals , There are some kind of Limitations for both the searching Algorithms but these are the widely                    used Data Structure Algorithms 
Conclusion:  
...
Its time complexity is O(n × W), space complexity is O(n × W), and the actual execution time is measured using time.perf_counter().
